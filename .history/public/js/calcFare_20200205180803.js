...
function calcFare() {
  ...
  var start = coordinates.from;
  var end = coordinates.to;
  var pax = parseInt(result.adult) + parseInt(result.child);
  var luggage = 3; // temporary placeholder
  var service = document.getElementById("hiddenService").value;
  var isAirport = result.4 from.includes("KLIA") ? true: false;
