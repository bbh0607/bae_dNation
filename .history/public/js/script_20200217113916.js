...
function handleChange(element) {
  ...
  if (changed.value === "SENTRAL" || changed.value === "OTHER") {
    if (compare.value === "SENTRAL" || compare.value === "OTHER") {
      compare.value = "DEFAULT";
      setGeoInfo(compare, "OTHER");
      if (compare.value==="OTHER") {
        displayCompare.hidden
      }
    }
  }
  ...
  console.log(prevObject.value, changed.value, compare.value);
