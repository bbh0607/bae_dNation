const queryString = require("query-string");
      ...
      console.log(parsed);
      var geoInfo = JSON.parse(localStorage["geoInfoJson"]);
      //   document.getElementById("result").innerText = geoInfo.from.lat;
      document.getElementById("result").innerText = location.search; 
...
function calcFare() {
  ...
  var trip = document.getElementById("triptype").value; //1 - Pickup, 2 - Airport, 3 - Hotel, 4 - Outstation
